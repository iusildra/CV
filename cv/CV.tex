...
\begin{multicols}{2}
  \Experience{Organizer}{Sunny Tech}{2022 --- today}{
    \begin{ItemList}{\ColorHighlight}
      ...
      \item[\ding{72}] 2023 --- today: Secretary
    \end{ItemList}
  }
  \columnbreak{}
...
\Experience{Website maintainer}{ScalaIO}{Dec. 2023 --- today}{
  ...
  Continued the work of the previous maintainer to rework the website with \ul{\href{https://www.scala-js.org/}{Scala.js}} and \ul{\href{https://laminar.dev/}{Laminar}} to build reactive SPA (Single-Page Application) with Scala. Used the \ul{\href{https://sass-lang.com}{Sass}} pre-processor to style the website.
  \begin{ItemList}{\ColorHighlight}
    \item[\ding{226}] Github Actions
    \item[\ding{226}] Clever Cloud deployment
    \item[\ding{226}] CSS Selectors
  \end{ItemList}
...
\Experience{Course}{Polytech Montpellier}{Nov. 2023}{
  \textit{Functional Programming, Type Classes, Scala, Parsers}
  \vspace{0.25cm}

  Gave a 3h course (for the first time) about building parsers with functional programing to master students, based on the \ul{\href{https://www.creativescala.org/case-study-parser/index.html}{Parser combinators}} workshop from \ul{\href{https://github.com/noelwelsh}{Noel Welsh}}:
  \begin{ItemList}{\ColorHighlight}
    \item[\ding{226}] Reminders about Scala \& Functional Programming
    \item[\ding{226}] Design with Functional Programming (type classes)
    \item[\ding{226}] Frequent and small exercices to apply the concepts
  \end{ItemList}

  The slides are available at \ul{\href{https://iusildra.github.io/reveal.js/presentations/functional-design-parser-combinators/index.html}{https://iusildra.github.io/reveal.js/presentations/functional-design-parser-combinators/index.html}}
}
