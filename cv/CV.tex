...
%                                   DOCUMENT                                   %
% ---------------------------------------------------------------------------- %
\def\cvSubject{\texttt{Option.empty[String]}}
...
%                                   PROJECTS                                   %
% ---------------------------------------------------------------------------- %
\TitleOne{\ColorHighlight}{Projects}{\faLaptopCode}
\Experience{\href{https://github.com/bde-polytech-montpellier}{Student Union Website (link)}}{Student Union}{2022---.}{
  I rebuilt from scratch the website of the student union of my school. I began with React + Express, then migrated to Nestjs + Prisma \& Nextjs. It helped me realize how important are design patterns

  The front-end, back-end and the database (PostgreSQL) are deployed on a Dokku server within Polytech, with a custom domain name hosted on Google Domains
}

\Experience{\href{https://github.com/iusildra/scalafix-remove-tokens}{Scalafix Remove Tokens (link)}}{Open-source}{2023---.}{
  While working on the Scala Debug Adapter with \ul{\href{https://scalameta.org/munit/}{MUnit}}, I often forgot to remove the \texttt{.only} test tag before pushing my code (resulting in CI crash). So I created a \ul{\href{https://scalacenter.github.io/scalafix}{Scalafix}} rule to remove all the \texttt{.only} tags from my codebase. Then I plan to add some configurations to make it more generic and publish it for broader usage.
}
...
%                                     MOOCs                                    %
% ---------------------------------------------------------------------------- %
\TitleOne{\ColorHighlight}{MOOCs}{\faChalkboardTeacher}
\Experience%
{\href{https://rockthejvm.com/courses/enrolled/1516063}{Advanced Scala}}
{\href{https://rockthejvm.com/}{RockTheJVM}}
{2023}
{%
  \begin{multicols}{3}
    \begin{ItemList}{\ColorHighlight}
      \item[\ding{72}] Monads
      \item[\ding{72}] Given \& Using (Implicits)
      \item[\ding{72}] Variance
      \item[\ding{72}] Concurrency
      \item[\ding{72}] Type Classes
      \item[\ding{72}] etc.
    \end{ItemList}
  \end{multicols}
}
...
\begin{multicols}{2}
  \Experience{Organizer}{Sunny Tech}{2022---.}{
    \begin{ItemList}{\ColorHighlight}
      ...
      \item[\ding{72}] Community Manager (\ul{\href{https://www.linkedin.com/company/18442273}{LinkedIn}}, \ul{\href{https://twitter.com/SunnyTech_MTP}{Twitter}})
      \item[\ding{72}] Call For Papers reviewer (450 talks)
      \item[\ding{72}] Track hosting (time management, Q\&A `helper')
      \item[\ding{72}] Attendees / sponsors guidance 
    \end{ItemList}
  }
  \Experience{Organizer}{ScalaIO}{2023---.}{
    \begin{ItemList}{\ColorHighlight}
      \item[\ding{72}] \ul{\href{https://scala.io/}{https://scala.io/}}
      \item[\ding{72}] Sponsors fishing
    \end{ItemList}
  }
  \Experience{Volunteer (Upcoming)}{Scala Days Madrid}{Sept. 2023---.}{
    \begin{ItemList}{\ColorHighlight}
      \item[\ding{72}] \ul{\href{https://scaladays.org/madrid-2023/}{https://scaladays.org/madrid-2023/}}
      \item[\ding{72}] Track hosting
    \end{ItemList}
  }
\end{multicols}
\end{document}
